classdef PhysioPeaksFinderApp < handle
    %
    % Usage:
    %     app.PhysioPeaksFinderApp
    ...
    properties (Constant)
        AppPathBase = {'/PhysioPeaksFinder'};
        AppClass = 'PhysioPeaksFinderApp';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function obj = PhysioPeaksFinderApp()
        ...
        function startApp(obj)
            ...
            mlock;
            PhysioPeaksFinderApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'PhysioPeaksFinder')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong PhysioPeaksFinder
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'PhysioPeaksFinder').getString, ...
            ...
            if nargout(@PhysioPeaksFinder) == 0
                eval('PhysioPeaksFinder');
            else
                obj.AppHandle = eval('PhysioPeaksFinder');
            end
